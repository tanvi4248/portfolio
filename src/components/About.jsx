export default function About() {
  return (
    <div
      id="About"
      className="px-10 mb-16 md:px-6 max-[480px]:px-4 max-[480px]:mb-8"
    >
      ...
      <br></br>
      <br></br>
      <h3 className="text-xxl max-[480px]:text-xl max-[480px]:pb-6 text-center main-title font-bold pb-10">
        Skills
      </h3>
      <p className="text-zinc-300 leading-relaxed">
        ...
        <br></br>
        <b>Designing Tool: </b>Photoshop, Figma Testing framework: Cypress, Jest
      </p>
    </div>
  );
}
